...
const contactList = [
  {
    userId: 1,
    name: "Asliddin Ziyodullayev",
    path: "profile-1.jpeg",
    time: "2:09 PM",
    preview: "Menga eng yaqin va navbat kam bank filiali",
    messages: [
      {
        fromUserId: 0,
        toUserId: 1,
        text: "Menga eng yaqin va navbat kam bank filiali",
      },
      {
        fromUserId: 1,
        toUserId: 0,
        text: "Eng yaqini Novza filiali tashrif buyurishga qulay vaqt 14:15 dan 14:30 gacha, hozirda navbat kamroq filial esa Amir Temur Xiyoboni filiali lokatsiyalar keyingi xabarda.",
      },
    ],
    active: true,
  },
  {
    userId: 2,
    name: "Alisherov Valisher",
    path: "profile-2.jpeg",
    time: "12:09 PM",
    preview: "Qaysi filialda to'lovlar uchun cashback olsam bo'ladi ",
    messages: [
      {
        fromUserId: 0,
        toUserId: 2,
        text: "Qaysi filialda to'lovlar uchun cashback olsam bo'ladi ",
      },
      {
        fromUserId: 2,
        toUserId: 0,
        text: "Hozirda Sergili filialimizda 14:00 dan 17:00 ga cha tashrif buyurgan mijozlarimizga 2% to'lov miqdori hisobiga qaytariliadi",
      },
      {
        fromUserId: 0,
        toUserId: 2,
        text: "Qaysi filialdan valyuta sotib olsam bo'ladi",
      },
      {
        fromUserId: 2,
        toUserId: 0,
        text: "Hamma filiallarimizda bu xizmat mavjud yoki mobil ilovada ham qulay. Olmazor filialida valyuta 0.5% ga arzonroq",
      },
      {
        fromUserId: 0,
        toUserId: 2,
        text: "Eng yaqin bankomat qayerda?",
      },
      {
        fromUserId: 2,
        toUserId: 0,
        text: "Hozirda sizni joylashuvingizga eng yaqin Mirzo Ulug'bek metro yaqinida G'afur G'ulom bog'i tarafda.",
      },
    ],
    active: false,
  },
    ...
    messages: [
      {
        fromUserId: 0,
        toUserId: 4,
        text: "Qayerda ta'lim krediti rasmiylashtirsam bo'ladi",
      },
      {
        fromUserId: 4,
        toUserId: 0,
        text: "Bu ishni online ravishda Agro Bank mobil ilovasi orqali amalga oshirsa bo'ladi",
      },
      {
        fromUserId: 0,
        toUserId: 4,
        text: "Ortiqcha pullarimni saqlashda maslahat kerak",
      },
      {
        fromUserId: 4,
        toUserId: 0,
        text: "Bunda Agro Bank Omonatlarida foydalansangiz bo'ladi",
      },
    ],
    active: true,
  },
...
const Chat = () => {
  ...
  return (
    <div>
      <div
        className={`flex gap-5 relative sm:h-[calc(100vh_-_50px)] h-full sm:min-h-0 ${
        ...
        >
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              ...
              <div className="mx-3">
                <p className="mb-1 font-semibold">Bot</p>
                <p className="text-xs text-white-dark">Support</p>
              </div>
            </div>
          ...
          <div className="!mt-0">
            <PerfectScrollbar className="chat-users relative h-full min-h-[100px] sm:h-[calc(100vh_-_257px)] space-y-0.5 ltr:pr-3.5 rtl:pl-3.5 ltr:-mr-3.5 rtl:-ml-3.5">
          ...
          {!isShowUserChat && (
            <div className="flex items-center justify-center h-full relative p-4">
              ...
              <div className="py-8 flex items-center justify-center flex-col">
                <div className="w-[280px] md:w-[430px] mb-8 h-[calc(100vh_-_220px)] min-h-[120px] text-white dark:text-black">
                  <svg
